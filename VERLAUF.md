...
- **Ordnerstruktur auflösen (Branch: feature/nas-structure-fix):**
  ...
  - **Stabile Klickverkabelung für Strukturaktionen:** Die neuen Buttons „Vorschau“, „Auflösen“ und „Ordnerstrukturen vorbereiten“ nutzen nun Event-Delegation auf dem Bibliotheksbereich, damit sie nach Polling/Re-Render weiterhin reagieren. `app.js` wurde auf `v=75` gebumpt, damit der Browser den Fix sicher neu lädt.
